...
```html
<script src="https://unpkg.com/@samline/forms@2.3.2/dist/browser/global.global.js"></script>
```

:::caution[Pin the version in production]
The CDN URL above uses `@2.3.2`. Replace the version with the one you ship.
:::
...
- **Pin the version.** The CDN URL above uses `@2.3.2`. Replace it whenever you upgrade.
