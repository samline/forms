...
6. scripts-reference.md
   Usar cuando haya que comparar la API pública del paquete con el comportamiento original de scripts.ts o cuando se necesite contexto interno de migración.
